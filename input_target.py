...
def conv2RGB(img,mode):
    ...
    df.to_csv(savepath + "/point_rbf_{}.csv".format(mode))
...
if __name__ == "__main__":
    ...
    init_path = os.getcwd()
    img = cv2.imread(init_path+'/chart_1_input.tif')
    savepath = init_path
    conv2RGB(img,"input")

    img = cv2.imread(init_path+'/chart_1_target.tif')
    savepath = init_path
    conv2RGB(img,"target")
